...
const Footer = () => {
    return (
        <div className='w-full mt-0 bg-gray-900 text-gray-300 py-2 px-2'>
            <div className='max-w-[1400px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8 px-4'>
                <div>
                    ...
                    <ul>
                        ...
                        <li className='py-1 cursor-pointer'>Flight</li>
            ...
            <div className='max-w-[1400px] flex flex-col px-2 py-4 mx-auto justify-between sm:flex-row text-center text-gray-500'>
                <p className='py-4'>2022 Experiences, LLC. All rights reserved.</p>
                <div className='flex justify-between sm:w-[300px] pt-4 text-2xl'>
                    <FaFacebook className='cursor-pointer'/>
                    <FaInstagram className='cursor-pointer'/>
                    <FaTwitter className='cursor-pointer'/>
                    <TiSocialPinterest className='cursor-pointer'/>
                </div>
            </div>
        </div>
    );
